## Debugging
1. **Find Queue Elements**: Open your target event page, press F12, and inspect the queue page (if present) for unique IDs or classes (e.g., `queue-it`, `queue-container`).
